...
- Curated retain now supports reviewed schema-v2 subset import plus local SQLite search/export/delete lifecycle proof. Schema-v1 dry-run remains review evidence only; external/Codex retain stays disabled until provider-specific search/export/delete behavior and an explicit enablement decision are verified.
