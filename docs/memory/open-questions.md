...
- Curated retain now has a lifecycle policy in `docs/memory/retain-policy.md`, but real retain/import remains disabled until the redaction/delete/export policy is implemented by tested tooling and a dry-run report.
